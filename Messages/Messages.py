...
class MSG(Enum):
    ...
    NAV_DOP = UBXMessages.NAV_DOP.header
...
ALL = set(MSG)
ON_LIST = {MSG.NAV_SAT, MSG.NAV_ORB, MSG.NAV_SVINFO, MSG.NAV_TIMEGPS, MSG.NAV_POSECEF, MSG.NAV_DGPS, MSG.NAV_CLOCK, MSG.NAV_DOP,
